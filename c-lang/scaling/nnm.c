...
int
nnm_shrinker_new(nnm_shrinker_t** dst)
{
  int ret;
  nnm_shrinker_t* obj;
...
int
nnm_shrinker_destroy(nnm_shrinker_t* ptr)
{
  int ret;
...
int
nnm_shrinker_setup(nnm_shrinker_t* ptr,
...
int
nnm_shrinker_alloc(nnm_shrinker_t* ptr, void** dst)
{
  int ret;
  void* buf;
...
int
nnm_shrinker_proc(nnm_shrinker_t* ptr, void* _src, void* _dst)
{
  int ret;
  uint8_t* src0;
  uint8_t* src;
